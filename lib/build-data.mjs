...
try {
  ...
  console.warn(
    "[build-data] better-sqlite3 no disponible (Vercel / entorno sin compilación nativa).\n" +
    "  El sitio usará Supabase como fuente de datos. Omitiendo generación de JSON local."
  );
  process.exit(0);
}
